...
public class TestSharedPreferences implements SharedPreferences {
    ...
    public Map<String, HashMap<String, Object>> content;
    private String filename;
    public int mode;

    public TestSharedPreferences(Map<String, HashMap<String, Object>> content, String name, int mode) {
    ...
    private Object getValue(String key, Object defValue) {
        HashMap<String, Object> fileHash = content.get(filename);
        if (fileHash != null) {
    ...
    private class TestSharedPreferencesEditor implements Editor {
        ...
        HashMap<String, Object> editsThatNeedCommit = new HashMap<String, Object>();
